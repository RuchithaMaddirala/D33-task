...
const AppLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <div 
        ref={resizeHandleRef}
        className="w-1 bg-slate-200 cursor-col-resize hover:bg-blue-300 transition-colors"
      ...
      <div className="absolute bottom-5 right-5">
        <button 
          ...
          className="w-12 h-12 bg-slate-200 rounded-full flex items-center justify-center shadow-md hover:bg-slate-300 transition-colors"
