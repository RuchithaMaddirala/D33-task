...
const MiddlePanel: React.FC = () => {
  ...
  return (
    <main className="flex-1 flex flex-col h-full overflow-auto bg-gray-900 relative">
      ...
      <header className="border-b border-gray-800 p-6 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Dashboard overview and analytics</p>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center text-gray-300 shadow-md hover:bg-gray-700 transition-colors">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 p-4 bg-gray-900 flex justify-start">
